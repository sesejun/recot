...
def main():
    ...
    extlen = 500
    fasta_file = '/home/akiko/Alyrata/data/Alyrata_107_RM.fa'
    gff_file = '/home/akiko/Alyrata/data/Alyrata_107_gene.gff3'
    gene_seq_file = '/home/akiko/Alyrata/ReadData/Alyrata_107_geneSeq.fa'
    
    makeGeneGFF(extlen, fasta_file, gff_file, gene_seq_file)
    
    print 'Output==', gene_seq_file
