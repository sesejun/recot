...
def getNewCigar_Foward_Foward(g_pos,gs,rs,gene_spos,gene_coorDic,gene_cigarDic,read_coorDic,read_cigarDic,
    ...
    for rc in range(0,len(read_coorDic)):
        ...
        cur_read_cigar = read_cigarDic[rc]
        if cur_read_cigar == 'M':
        ...
        #end if cur_read_cigar == 'M':
        
        elif cur_read_cigar == 'I':
            for gc in range(gene_spos,len(gene_coorDic)):
                if gene_cigarDic[gc] == 'M':
                    if gene_coorDic[gc] != '*':
                             newpos = int(gene_coorDic[gc])
                    #print '-------------',gc,gene_coorDic[gc],gene_cigarDic[gc],gene_seqDic[gc]
                    basecigar = basecigar + cur_read_cigar
                    break
                elif gene_cigarDic[gc] == 'I':
                    if gene_coorDic[gc] != '*':
                             newpos = int(gene_coorDic[gc])
                    ...
                    basecigar = basecigar + cur_read_cigar
                    break
        #end if cur_read_cigar == 'I':
        
        elif cur_read_cigar == 'D':
            for gc in range(gene_spos,len(gene_coorDic)):
                if gene_cigarDic[gc] == 'M':
                    #print '-------------',gc,gene_coorDic[gc],gene_cigarDic[gc],gene_seqDic[gc]
                    if gene_coorDic[gc] != '*':
                    ...
                    gene_spos = gc + 1
                    break
        #end if cur_read_cigar == 'D':
        
        elif cur_read_cigar == 'N':
            for gc in range(gene_spos,len(gene_coorDic)):
                if gene_cigarDic[gc] == 'M':
                    #print '-------------',gc,gene_coorDic[gc],gene_cigarDic[gc],gene_seqDic[gc]
                    if gene_coorDic[gc] != '*':
                    ...
                    gene_spos = gc + 1
                    break
        #end if cur_read_cigar == 'N':
        
        elif cur_read_cigar == 'S':
            for gc in range(gene_spos,len(gene_coorDic)):
                if gene_cigarDic[gc] == 'M':
                    #print '-------------',gc,gene_coorDic[gc],gene_cigarDic[gc],gene_seqDic[gc]
                    if gene_coorDic[gc] != '*':
                    ...
                    gene_spos = gc + 1
                    break
        #end if cur_read_cigar == 'S':
        
        elif cur_read_cigar == 'H':
            for gc in range(gene_spos,len(gene_coorDic)):
                if gene_cigarDic[gc] == 'M':
                    #print '-------------',gc,gene_coorDic[gc],gene_cigarDic[gc],gene_seqDic[gc]
                    if gene_coorDic[gc] != '*':
                    ...
                    basecigar = basecigar + cur_read_cigar
                    break
        #end if cur_read_cigar == 'H':
        
        elif cur_read_cigar == 'P':
            for gc in range(gene_spos,len(gene_coorDic)):
                if gene_cigarDic[gc] == 'M':
                    #print '-------------',gc,gene_coorDic[gc],gene_cigarDic[gc],gene_seqDic[gc]
                    if gene_coorDic[gc] != '*':
...
def MainSubCompare(new_read_file,rnameList,SAM_atline,gid_dic,gsam_line_dic):
    ...
    for ch in rnameList:
        ...
        write_line = 0
        geneSamList = []
        geneCigarAll = {} # geneCigarAll[rID][0]: forward info, geneCigarAll[rID][0]: reverse info
        ...
        for line in lines1:
            ...
            if id != rg_gID:
                ...
                if (rg_gID in gid_dic) == True:
                    #geneSamList = getsameIDList(ch,rg_gID, gene_file)
                    #print 'id',rg_gID,'gid_dic:',gid_dic[rg_gID]
                    for x in gid_dic[rg_gID].split(','):
                        #print x
                        #print gsam_line_dic[x]
                        geneSamList.append(gsam_line_dic[x])
                    #end for x in gid_dic[rg_gID].split(','):
                    #print 'geneSamList:', len(geneSamList)
                elif (rg_gID in gid_dic) == False:
                    continue
            ...
            for g in geneSamList:
                ...
                #log.debug('Now converting: (Read)' + rg_rID + ',(Gene)' + itemList[0])
                ...
                if greverse == False:
                    if rg_gdirect == '+':
                        ...
                        if geneCigarAll.has_key(rID) and not geneCigarAll[rID][0] == []:
                            gene_coorDic, gene_cigarDic, gene_seqDic = geneCigarAll[rID][0]
                        else:
                            gene_coorDic,gene_cigarDic,gene_seqDic = addCigarSeq(g_cigar,g_seq)
                            if not geneCigarAll.has_key(rID):
                                geneCigarAll[rID] = [[],[]] # [0]:forward, [1]: reverse
                            geneCigarAll[rID][0] = gene_coorDic,gene_cigarDic,gene_seqDic
                ...
                if greverse == True:
                    if rg_gdirect == '+':
                        ...
                        if geneCigarAll.has_key(rID) and not geneCigarAll[rID][1] == []:
                            gene_coorDic, gene_cigarDic, gene_seqDic = geneCigarAll[rID][1]
                        else:
                            gene_coorDic,gene_cigarDic,gene_seqDic = addCigarSeq(reverse_cigar,reverse_seq)
                            if not geneCigarAll.has_key(rID):
                                geneCigarAll[rID] = [[],[]] # [0]:forward, [1]: reverse
                            geneCigarAll[rID][1] = gene_coorDic,gene_cigarDic,gene_seqDic
...
def main():
    ...
    gid_dic,gsam_line_dic = getGeneList(gene_sam_file)
    getChrSAMfile(gene_sam_file,rnameList)
    SAM_header = getSAMheader(gene_sam_file)
    MainSubCompare(out_file,rnameList,SAM_header,gid_dic,gsam_line_dic)
